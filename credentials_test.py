...
class TestCredentials(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.new_credentials = Credentials("facebook","ebenezer","qwerty")
  def tearDown(self):  
  ...
  def test_init(self):
    ...
    self.assertEqual(self.new_credentials.user_id, "ebenezer")
    self.assertEqual(self.new_credentials.passcode, "qwerty")
